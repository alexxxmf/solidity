...
declare module "react-native-offline" {
  ...
  export interface CheckInternetConnectionConfig {
    url?: string;
    pingTimeout?: number;
    shouldPing?: boolean;
  }
  ...
  export interface NetworkConsumerProps {
  ...
  export const networkSaga: (
    config: NetworkProviderProps
